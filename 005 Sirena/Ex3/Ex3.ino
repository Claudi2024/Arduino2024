...
void loop()
{
  ...
  tone(xiulet,2000,300);   // xiulet de durada valPot0
  delay(500);
  tone(xiulet,1500,300);
  delay(500);
  tone(xiulet,1600,300);
  delay(500);
  tone(xiulet,1000,300);
  delay(2*1000);            // esperar valPot0 del xiulet + valPot0 silenci
